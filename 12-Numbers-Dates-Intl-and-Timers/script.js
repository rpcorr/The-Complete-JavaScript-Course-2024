...
// console.log(parseFloat(' 2.5rem  '));  works but not encouraged.

// Check if value is NaN
console.log(Number.isNaN(20));
console.log(Number.isNaN('20'));
console.log(Number.isNaN(+'20X'));
console.log(Number.isNaN(23 / 0)); // produce infinity

// The best way checking if a value is a number
...
console.log(25 ** (1 / 2)); // produce the same as the line above
console.log(8 ** (1 / 3)); // cubic root produce 2
...
// calculate a circle's  area with a radius of 10
console.log(Math.PI * Number.parseFloat('10px') ** 2);

// Randomize number between 1 and 6
console.log(Math.trunc(Math.random() * 6) + 1);

// Random function between any two numbers
...
// ceil bumps up the integer
console.log('Ceil');
console.log(Math.ceil(23.3)); // 24
console.log(Math.ceil(23.9)); // 24

// floor bumps down the integer
console.log('Floor');
console.log(Math.floor(23.9)); // 23
console.log(Math.floor(23.9)); // 23
console.log(Math.floor('23.9')); // 23

// trunc remove the decimal
...
console.log(8 % 2); // 0
console.log(8 % 3); // 2
console.log(8 / 3); // 2.666666665 // 8 = 2 * 3 + 2
