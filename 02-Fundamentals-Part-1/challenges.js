...
let bill = 275;
let tip = getTip(bill);
output('Scenerio 1', bill, tip);

bill = 40;
tip = getTip(bill);
output('Scenerio 2', bill, tip);

bill = 430;
tip = getTip(bill);
output('Scenerio 3', bill, tip);
...
function output(scenerio, bill, tip) {
  console.log(`${scenerio}:\n`);
  console.log(`The bill was $${bill}.`);

  console.log(
    `1. Calculate the tip, depending on the bill value: Tip is ${tip * 100}%.`
  );

  console.log(
    `2. The bill was $${bill}, the tip was $${
      bill * tip
